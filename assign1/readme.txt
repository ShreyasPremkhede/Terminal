This is a terminal which executes almost every LINUX command using system() function. 
...
-> Now run the following commands: 
    ...
    -> "./shell" (To execute the terminal.)

    
Commands except 'cd' and 'exit' are getting executed through system().
